...
server.bootstrap([client_router_1.clientRouter, employee_router_1.employeeRouter, address_router_1.addressRouter, position_router_1.positionRouter, service_router_1.serviceRouter, payment_router_1.paymentRouter, schedule_router_1.scheduleRouter, attendance_router_1.attendanceRouter]).then(server => {
